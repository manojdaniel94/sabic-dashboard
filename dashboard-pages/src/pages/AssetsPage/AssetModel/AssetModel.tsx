        ...
        <div className="asset-model-left-inner">
          <div className="asset-sensor-filter">
            ...
            <div className="sensor-options">
              <select onChange={(e) => setSelectedAssetId(e.target.value)}>
        ...
        <div className="asset-plot-status">
          <div className="asset-plot-status-left">
            {AssetKPIForAssetModel.map((item: any) => (
              <div className="asset-efficiency hovermeyaar">
                <span
                  className={
                    item.kpiTrend === true ? "uparrow greeny" : "downarrow redy"
                  }
                ></span>
                <span>{item.kpi}</span>{" "}
          ...
          <div className="asset-plot-status-right hovermeyaar">
            <div className="asset-status-graph">
              ...
              <div className="asset-status-tooltip asg-pos">
                <div className="asp-graph">
                  <img src={Tooltipgraph} />
                </div>
              </div>
            </div>
          </div>
