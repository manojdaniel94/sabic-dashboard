      ...
      <div id="pmt-left">
        <div id="pmt-asset-card">
          ...
          <div className="pmt-filter">
            <div className="pmt-asset-name">
              {selectedAssetId === "" ? "Poly 2" : selectedAssetId.label}
            </div>
            ...
            <div className="pmt-error">
              {getErrorMag === true ? (
                <span className="PmtErrorMsg">Need to select AssetID</span>
              ) : (
                ""
              )}
            </div>
        ...
        <PlantAlertList data={plantAlertSpmt} />
      </div>
      <div id="pmt-right">
        <>
          ...
          <div className="pmt-right-dropdown">
            <Dropdown
